...
(function() {
  var Daemon, DnsServer, EventEmitter, HttpsServer, fs, path,
  ...
  module.exports = Daemon = (function(_super) {
    ...
    function Daemon(configuration) {
      ...
      this.httpsServer = new HttpsServer(this.configuration);
    ...
    Daemon.prototype.start = function() {
      ...
      return startServer(this.httpsServer, httpPort, function(err) {
        if (err) {
          return flunk(err);
        } else {
    ...
    Daemon.prototype.stop = function() {
      ...
      return stopServer(this.httpsServer, function() {
