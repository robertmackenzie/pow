...
(function() {
  var HttpsServer, RackApplication, connect, dirname, fs, join, pause, request, url, version, _ref,
  ...
  module.exports = HttpsServer = (function(_super) {
    ...
    function HttpsServer(configuration) {
      var _this = this;
      ...
      HttpsServer.__super__.constructor.call(this, {
        key: fs.readFileSync(this.configuration.key),
        cert: fs.readFileSync(this.configuration.cert)
      }, [o(this.logRequest), o(this.annotateRequest), o(this.handlePowRequest), o(this.findHostConfiguration), o(this.handleStaticRequest), o(this.findRackApplication), o(this.handleProxyRequest), o(this.handleRvmDeprecationRequest), o(this.handleApplicationRequest), x(this.handleErrorStartingApplication), o(this.handleFaviconRequest), o(this.handleApplicationNotFound), o(this.handleWelcomeRequest), o(this.handleRailsAppWithoutRackupFile), o(this.handleLocationNotFound)]);
      this.staticHandlers = {};
    ...
    HttpsServer.prototype.toJSON = function() {
      return {
        pid: process.pid,
        version: version,
    ...
    HttpsServer.prototype.logRequest = function(req, res, next) {
      this.accessLog.info("[" + req.socket.remoteAddress + "] " + req.method + " " + req.headers.host + " " + req.url);
      this.requestCount++;
      return next();
    };

    HttpsServer.prototype.annotateRequest = function(req, res, next) {
      var host, _ref1;
    ...
    HttpsServer.prototype.handlePowRequest = function(req, res, next) {
      if (req.pow.host !== "pow") {
        return next();
      }
      switch (req.url) {
    ...
    HttpsServer.prototype.findHostConfiguration = function(req, res, next) {
      var resume,
        _this = this;
    ...
    HttpsServer.prototype.handleStaticRequest = function(req, res, next) {
    ...
    HttpsServer.prototype.findRackApplication = function(req, res, next) {
      var root,
        _this = this;
      ...
      return fs.exists(join(root, "config.ru"), function(rackConfigExists) {
    ...
    HttpsServer.prototype.handleProxyRequest = function(req, res, next) {
    ...
    HttpsServer.prototype.handleRvmDeprecationRequest = function(req, res, next) {
    ...
    HttpsServer.prototype.handleApplicationRequest = function(req, res, next) {
      var application;
    ...
    HttpsServer.prototype.handleFaviconRequest = function(req, res, next) {
    ...
    HttpsServer.prototype.handleApplicationNotFound = function(req, res, next) {
    ...
    HttpsServer.prototype.handleWelcomeRequest = function(req, res, next) {
      var domain, domains;
    ...
    HttpsServer.prototype.handleRailsAppWithoutRackupFile = function(req, res, next) {
      var root;
    ...
    HttpsServer.prototype.handleLocationNotFound = function(req, res, next) {
      res.writeHead(404, {
    ...
    HttpsServer.prototype.handleErrorStartingApplication = function(err, req, res, next) {
