...
(function() {
  ...
  module.exports = Configuration = (function() {
    ...
    Configuration.prototype.initialize = function(env) {
      var _base, _base1, _ref, _ref1, _ref10, _ref11, _ref12, _ref13, _ref14, _ref15, _ref2, _ref3, _ref4, _ref5, _ref6, _ref7, _ref8, _ref9;
      ...
      this.cert = (_ref13 = env.POW_CERT) != null ? _ref13 : libraryPath("Keychains", "Pow", "cert.pem");
      this.key = (_ref14 = env.POW_KEY) != null ? _ref14 : libraryPath("Keychains", "Pow", "key.pem");
      this.rvmPath = (_ref15 = env.POW_RVM_PATH) != null ? _ref15 : path.join(process.env.HOME, ".rvm/scripts/rvm");
